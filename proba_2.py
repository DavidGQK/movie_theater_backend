...
VALUES (%s, %s)""", data)
    ...
    data.seek(0)
    # cursor.copy_from(data, 'content.temp_table', sep=',', columns=['id', 'name']) # THIS COMMAND DOESN"T WORK DUE TO POSSIBILITY OF SQL-INJECTION
    cursor.copy_expert("COPY content.temp_table FROM STDIN WITH DELIMITER ',' NULL '';", data)
